...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	public void mouseMoved(MouseEvent e) {
		...
		int background = -1;
		int end = -131072;
		// 8. If the mouse fall off the path (if it is on the background)
...
JOptionPane.showMessageDialog(null, "You Won !!!!");
	...
	private void scare() {
		...
		AudioClip sound = JApplet.newAudioClip(getClass().getResource("scary2.wav"));

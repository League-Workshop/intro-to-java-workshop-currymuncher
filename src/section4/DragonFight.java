...
public class DragonFight {
	...
	public static void main(String[] args) {
		...
		while (playerHealth > 0 && dragonHealth > 0) { // this line of code keeps the battle going until someone's
			...
			// or a kick
			// String attack = JOptionPane.showInputDialog("do yoy eant to attack the dragon
			// with a yell or a kick");
			int answer = JOptionPane.showOptionDialog(null, "Do you want to attack the  dragon with a yell or a kick",
					"Dragon Fight", 0, JOptionPane.INFORMATION_MESSAGE, null, new String[] { "Yell", "kick" }, null);
...
//			}
			...
			// 15. Else
				...
				JOptionPane.showInputDialog(dragonHealth + playerHealth);
			}
